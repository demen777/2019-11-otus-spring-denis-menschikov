...
public class DatabaseChangelog {
    private static final Genre GENRE_NOVEL = new Genre(1L, "Роман");
    private static final Author AUTHOR_TOLSTOY = new Author(1L, "Лев", "Толстой");
    ...
    public void addBooks(MongoTemplate mongoTemplate) {
        mongoTemplate.save(new Book(1L, "Война и мир", AUTHOR_TOLSTOY, GENRE_NOVEL));
    }
}
