...
public class AuthorControllerSecurityTest {
    public static final String AUTHOR_URI = "/authors";
    public static final String GET_ADD_AUTHOR_URI = "/author/add";
    public static final String POST_ADD_AUTHOR_URI = "/author/add?firstName=abc&surname=def";
    ...
    @ParameterizedTest
    @ValueSource(strings = {AUTHOR_URI})
    ...
    @ParameterizedTest
    @ValueSource(strings = {GET_ADD_AUTHOR_URI})
    ...
    @WithMockUser(username = "user", roles = "USER")
    @ParameterizedTest
    @ValueSource(strings = {POST_ADD_AUTHOR_URI})
    ...
    @ParameterizedTest
    @ValueSource(strings = {AUTHOR_URI, GET_ADD_AUTHOR_URI})
    ...
    public void post_with_operator_redirect(String url) throws Exception {
        mockMvc.perform(post(url)).andExpect(status().isFound())
            .andExpect(redirectedUrl(AUTHOR_URI));
    }
}
